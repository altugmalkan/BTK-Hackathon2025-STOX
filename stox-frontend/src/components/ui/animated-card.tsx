...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] bg-[#f9fafb]/90 dark:bg-black/90 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group backdrop-blur-sm shadow-lg dark:shadow-2xl dark:shadow-emerald-500/20",
        className
      )}
    >
      {children}
...
export const GeminiLogo = ({ className }: { className?: string }) => {
  return (
<svg width="344" height="127" viewBox="0 0 344 127" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("w-full h-auto", className)}>
<mask id="mask0_958_15881" style={{maskType: "alpha"}} maskUnits="userSpaceOnUse" x="0" y="0" width="344" height="127">
